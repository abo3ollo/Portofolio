...
const SKILLS = ["Product Design", "UX Design", "UI Design", "Framer", "Branding", "Webflow"];
...
export default function AboutSection() {
    return (
        <section className="w-full min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-6 py-20 font-[Plus_Jakarta_Sans]">
            {/* ── Top Badge ── */}
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-[#111] border border-white/[0.07] rounded-2xl p-6 flex flex-col gap-6">
                    ...
                    {/* Name & title */}
                    <div>
                        <h2 className="text-white text-2xl font-semibold mb-1">Hello I am Johan Beker</h2>
                        <p className="text-white/40 text-md">UI/UX Interaction Designer Based in Berlin.</p>
                    </div>
                    ...
                    {/* CTA */}
                    <Link href="#projects" className="w-[40%] text-center py-3 rounded-[30px] text-base font-medium text-white border border-white/20 bg-transparent transition-all duration-300 hover:bg-white/5 hover:border-white/30 no-underline">
                        Connect with me 
                    </Link>
                </div>
